package com.korkmaz.kubra.auth.controller;
...
import com.korkmaz.kubra.auth.services.AuthenticationService;
...
public class AuthenticationController {
    ...
    public void activateAccount(
            @RequestParam String activeToken
    ) throws MessagingException {
        service.activateAccount(activeToken);
    }
}
